...
class KryptonClient:
    def __init__(self, email: str, base_url: str = "http://127.0.0.1:8000", api_key: str = None):
...
Usage:
    ...
    # 1. Provide your email and connect
    client = KryptonClient(email="test@example.com", base_url="https://your-ngrok.dev")
    
    # 2. Get your key, or ping the offline server
    client.join_queue()
